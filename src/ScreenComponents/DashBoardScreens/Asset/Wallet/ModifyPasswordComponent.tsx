...
const ModifyPasswordComponent = ({route, navigation}: Props) => {
  ...
  const oldPasswordFieldRef = useRef<TextInput>(null);
  const passwordFieldRef = useRef<TextInput>(null);

  const [walletChangePwd, {isLoading}] = useWalletChangePwdMutation();
  ...
  const onConfirm = async () => {
    ...
    try {
      ...
      const response: any = await walletChangePwd(payload).unwrap();
      if (response?.success) {
        showToast({
          type: 'success',
    ...
    <>
      ...
      <SafeAreaView style={appStyles.container}>
        ...
        <View style={styles.topView}>
          ...
          <View style={styles.searchContainer}>
            <TextInput
              ...
              onSubmitEditing={() => oldPasswordFieldRef.current?.focus()}
            />
        ...
        <View style={styles.bottomView}>
          <TouchableOpacity
            style={[styles.startedTouch, touchDisabled && styles.touchOpacity]}
